...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_lohasle_nimbus-cloud-framework-go_internal_platform_httpx.Response"
                        }
                    }
                }
            }
        },
        "/admin-api/application/health": {
            "get": {
                "description": "Health endpoint for deployment probes and service-governance checks.",
                "produces": [
                    "application/json"
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/member.GroupSaveRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/member.LevelSaveRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/member.TagSaveRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/member.UserSaveRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/pay.AppSaveRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/pay.ChannelSaveRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/pay.OrderCreateRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/pay.RefundCreateRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/pay.RefundUpdateRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/pay.WalletBalanceUpdateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/system/health": {
            "get": {
                "description": "Health endpoint used by deployment probes and service governance.",
                "produces": [
                    "application/json"
                ],
                "tags": [
    ...
    "definitions": {
        "github_com_lohasle_nimbus-cloud-framework-go_internal_platform_httpx.Response": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer",
        ...
        "pay.WalletBalanceUpdateRequest": {
            "type": "object",
            "required": [
                "balance",
                "userId"
