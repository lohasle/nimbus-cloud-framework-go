...
func Open(cfg config.Config) (*gorm.DB, error) {
	...
	slog.Info("mysql initialized", "database", "nimbus_cloud_go")
	return db, nil
}

// Connect opens the shared MySQL connection without applying a module schema.
// Each bounded context owns its migrations and seed data.
